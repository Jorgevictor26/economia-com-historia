...
export class AdminDashboardPage {
  ...
  readonly metrics: DashboardMetric[] = [
    { label: 'Engajamento médio', value: '8.4 / 10', note: '+Comentários e interações', accent: '#5c1e2f' },
    { label: 'Membros ativos', value: '1,842', note: '+4.6% novos hoje', accent: '#8A3F50' },
    { label: 'Taxa de retenção', value: '97.6%', note: 'Alta fidelidade', accent: '#5c1e2f' },
  ...
  readonly topStudentsSignal = signal<StudentRank[]>([
    { position: 1, name: 'Carlos Tchipia', course: 'Gestão', score: 950, avatar: 'CT' },
    { position: 2, name: 'Jussana Paim', course: 'Contabilidade', score: 920, avatar: 'JP' },
    { position: 3, name: 'David Jaspe', course: 'Gestão', score: 980, avatar: 'DJ' },
  ...
  readonly contentBars: ContentBar[] = [
    ...
    { label: 'Quiz', value: 66 },
    { label: 'Conteúdo', value: 96 },
    { label: 'Fórum', value: 44 },
